...
public class NearbyVerificationResponseVO {

    private long id;
    private long verificationDate;
    private NearbyAddressVO address;
    ...
    public NearbyAddressVO getAddress() {
        return address;
    }

    public void setAddress(NearbyAddressVO address) {
